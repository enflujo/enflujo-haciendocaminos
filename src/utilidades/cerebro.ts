...
export const nombresListasProyectos = {
  ...
  vinculaciones: 'Tipo de vinculación',
  ...
  if (!enEgresados) {
    if (tipo === 'proyecto') {
      ...
      datosFicha.set({
        ...
        vinculaciones: datosProyecto.vinculaciones ? datosProyecto.vinculaciones : [],
      ...
      if (datos) {
        ...
        datosFicha.set({
          ...
          vinculaciones: relaciones.vinculaciones ? relaciones.vinculaciones : [],
